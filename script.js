document.addEventListener ('DOMContentLoaded', function () {
    ...
    navToggle.addEventListener('click', function(){
        // Alternar clase activa en el menu
        ...
        navToggleLines[0].classList.toggle('nav__toggle-line--middle-active');
        navToggleLines[0].classList.toggle('nav__toggle-line--bottom-active');
    });
});